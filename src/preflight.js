...
export function describeDowngrade(scan, aborting) {
  ...
  return (
    ...
    (aborting
      ? `  Nothing has been written. Install ${scan.highest} or later, or drop --strict to regenerate anyway.`
      : `  Install ${scan.highest} or later if that isn't what you meant — and check the diff before committing.`)
  );
}
