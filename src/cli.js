    ...
    if (result.priorVersion && !reportedDowngrades.has(result.path)) {
      diagnostics.push({
        ...
        message:
          ...
          `committing: install ${result.priorVersion} or later if the generator is what went backwards, ` +
          'or reset this file to its committed state if the output is what came forward.',
        file: result.path,
        tag: meta.tag,
        framework,
